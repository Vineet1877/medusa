...
export class Migration20250321114703 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table if exists "order" add column if not exists "product_id" text null;`);
  ...
  override async down(): Promise<void> {
    this.addSql(`alter table if exists "order" drop column if exists "product_id";`);
